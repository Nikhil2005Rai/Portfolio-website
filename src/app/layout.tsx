...
export const metadata: Metadata = {
  title: "Nikhil Rai's Portfolio",
  description: "Nikhil Rai's Personal portfolio",
};
  ...
  return (
    <html lang="en">
      ...
      >
        ...
        <div className="bg-[#dbd7fb] absolute top-[-1rem] -z-[10] flex-1 left-[-35rem] h-[31.25rem] w-[50rem] rounded-full blur-[10rem] sm:w-[68.75 rem] md:left-[-33rem] lg: left-[-28rem] xl:left-[-15rem] 2xl:left-[-5rem] dark:bg-[#676394]"></div>
